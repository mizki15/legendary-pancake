...
ut_eitan_quiz_bp_1 = Blueprint(
    'ut_eitan_quiz_1',
    __name__,
    url_prefix='/ut-eitan-quiz-1',
...
def load_data():
    ...
    sentences_path = os.path.join(base_dir, 'sentences_1.json')
