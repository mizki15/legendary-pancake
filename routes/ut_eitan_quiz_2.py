...
def load_data():
    ...
    sentences_path = os.path.join(base_dir, 'sentences_2.json')
...
@ut_eitan_quiz_bp_2.route('/check', methods=['POST'])
def check_answer():
    """解答を判定するAPI endpoint"""
