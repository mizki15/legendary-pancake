...
ut_eitan_quiz_bp_5 = Blueprint(
    'ut_eitan_quiz_5',
    __name__,
    url_prefix='/ut-eitan-quiz-5',
...
def load_data():
    ...
    sentences_path = os.path.join(base_dir, 'sentences_5.json')
...
@ut_eitan_quiz_bp_5.route('/check', methods=['POST'])
def check_answer():
    """解答を判定するAPI endpoint"""
