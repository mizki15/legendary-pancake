...
ut_eitan_quiz_bp_6 = Blueprint(
    'ut_eitan_quiz_6',
    __name__,
    url_prefix='/ut-eitan-quiz-6',
...
def load_data():
    ...
    sentences_path = os.path.join(base_dir, 'sentences_6.json')
...
@ut_eitan_quiz_bp_6.route('/check', methods=['POST'])
def check_answer():
    """解答を判定するAPI endpoint"""
