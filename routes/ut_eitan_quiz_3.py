...
ut_eitan_quiz_bp_3 = Blueprint(
    'ut_eitan_quiz_3',
    __name__,
    url_prefix='/ut-eitan-quiz-3',
...
def load_data():
    ...
    sentences_path = os.path.join(base_dir, 'sentences_3.json')
...
@ut_eitan_quiz_bp_3.route('/check', methods=['POST'])
def check_answer():
    """解答を判定するAPI endpoint"""
